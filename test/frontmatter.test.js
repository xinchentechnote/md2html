...
test('renderMarkdown: 参数 > frontmatter > 默认值', async () => {
  ...
  assert.ok(a.html.includes('三连'), 'footer:true 参数开启页脚')
  // frontmatter 生效（theme/title/date）；头卡默认渲染、页脚默认不追加
